  ...
  \hbox{%
    \begin{beamercolorbox}[wd=\paperwidth,ht=0.54cm,dp=0.15cm,leftskip=0.38cm,rightskip=0.3cm]{footline}
      \begin{minipage}[c][0.54cm][c]{0.70\paperwidth}
        \centering{\scriptsize\bfseries Oakland University}\hspace{0.55em}{\scriptsize School of Engineering and Computer Science}
      \end{minipage}%
      \begin{minipage}[c][0.54cm][c]{0.14\paperwidth}
        \centering{\scriptsize\insertframenumber/\inserttotalframenumber}
      \end{minipage}%
