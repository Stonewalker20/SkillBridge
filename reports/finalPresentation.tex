...
\newcommand{\oaklandbrandmark}{%
  \IfFileExists{\oaklandlogopath}{%
    \includegraphics[height=0.30cm]{\oaklandlogopath}%
  }{%
...
\newcommand{\oaklandbrandbadge}{%
  \raisebox{0.10cm}{\tikz[baseline=(box.base)]\node[rounded corners=4pt, fill=oustone, inner xsep=3.5pt, inner ysep=0.8pt] (box) {\oaklandbrandmark};}%
}
