...
\begin{titlepage}
  \centering
  \vspace*{1in}
  {\LARGE \textbf{Weekly Progress Reports}\par}
  \vspace{0.01in}
  \includegraphics[width=0.75\textwidth]{images/newSkillBridgelogo.png}\\
  \vspace{0.01in}
  ...
  \vfill
  {\large \textbf{Reports Included:} Weeks 1 through Midterm\par}
\end{titlepage}
