...
async def rewards_summary(user=Depends(require_user)):
    ...
    return RewardsSummaryOut(
        ...
        mastered_badge_count=progress_counts["mastered_badge_count"],
        tier_step_unlocked_count=progress_counts["tier_step_unlocked_count"],
        tier_step_total_count=progress_counts["tier_step_total_count"],
        completion_pct=progress_counts["completion_pct"],
